...
enum FFHlMediaCodecPcmFormat ff_hlmediacodec_get_pcm_format(
    enum AVSampleFormat sample_fmt);
enum AVSampleFormat ff_hlmediacodec_get_sample_fmt(
    enum FFHlMediaCodecPcmFormat pcm_fmt);
enum FFHlMediaCodecColorFormat ff_hlmediacodec_get_color_format(
    enum AVPixelFormat pix_fmt);
enum AVPixelFormat ff_hlmediacodec_get_pix_fmt(
